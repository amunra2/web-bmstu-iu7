...
<style scoped>
  .select {
    ...
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' version='1.1' height='15px' width='15px'%3E%3Ctext x='0' y='10' fill='cyan'%3E%E2%96%BE%3C/text%3E%3C/svg%3E");
